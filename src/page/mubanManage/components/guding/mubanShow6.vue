<template>
    <div class="fillcontain" ref="fillcontain">
        <div class="info_container" ref="info_container">
            ...
            <el-card class="box-card" style="width: 960px;margin: 1px auto;"><img style="width: 900px;height: 150px;padding-top: 10px;" :src="muban6_Img" /></el-card>
