<template>
    <div class="fillcontain" ref="fillcontain">
        <div class="info_container" ref="info_container">
            ...
            <el-card class="box-card" style="width: 960px;margin: 1px auto;"><img
                    style="width: 900px;height: 150px;padding-top: 10px;" :src="muban2_Img"/></el-card>
            <el-card class="box-card" v-for="i in input_num" style="width: 960px;min-height: 60px;margin: 0px auto;">
                <el-input v-model="namelist[i-1].name" placeholder="请输入被测评人姓名" size="large" clearable
                          style="width: 300px;padding-left:10px;float:left;"></el-input>
            </el-card>
